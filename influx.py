...
while True:
    try:
        ...
        body = 'gpsdo,host=%s proc_temp=%.2f,dcxo_temp=%.2f,pll_error=%.1f,pll_rmse=%.1f,pll_ppm=%.4f,comp_m=%.1f,comp_b=%.1f,comp_v=%.1f' % (
            gpsdoHost, proc_temp, dcxo_temp, err_mean, err_rms, pll_ppm, comp_coef, comp_bias, comp_val
        )
